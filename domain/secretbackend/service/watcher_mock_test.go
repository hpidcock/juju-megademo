...
//
//	mockgen -typed -package service -destination domain/secretbackend/service/watcher_mock_test.go github.com/juju/juju/core/watcher StringsWatcher,NotifyWatcher
//
