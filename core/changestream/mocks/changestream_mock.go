...
//
//	mockgen -typed -package mocks -destination mocks/changestream_mock.go github.com/juju/juju/core/changestream ChangeEvent
//
...
func (m *MockChangeEvent) SpanID() string {
	m.ctrl.T.Helper()
...
func (mr *MockChangeEventMockRecorder) SpanID() *MockChangeEventSpanIDCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SpanID", reflect.TypeOf((*MockChangeEvent)(nil).SpanID))
	return &MockChangeEventSpanIDCall{Call: call}
}

// MockChangeEventSpanIDCall wrap *gomock.Call
type MockChangeEventSpanIDCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockChangeEventSpanIDCall) Return(arg0 string) *MockChangeEventSpanIDCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockChangeEventSpanIDCall) Do(f func() string) *MockChangeEventSpanIDCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockChangeEventSpanIDCall) DoAndReturn(f func() string) *MockChangeEventSpanIDCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// TraceID mocks base method.
func (m *MockChangeEvent) TraceID() string {
	m.ctrl.T.Helper()
...
func (mr *MockChangeEventMockRecorder) TraceID() *MockChangeEventTraceIDCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TraceID", reflect.TypeOf((*MockChangeEvent)(nil).TraceID))
	return &MockChangeEventTraceIDCall{Call: call}
}

// MockChangeEventTraceIDCall wrap *gomock.Call
type MockChangeEventTraceIDCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockChangeEventTraceIDCall) Return(arg0 string) *MockChangeEventTraceIDCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockChangeEventTraceIDCall) Do(f func() string) *MockChangeEventTraceIDCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockChangeEventTraceIDCall) DoAndReturn(f func() string) *MockChangeEventTraceIDCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
