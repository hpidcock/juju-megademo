...
//
//	mockgen -typed -package externalcontrollerupdater_test -destination apiserver/facades/controller/externalcontrollerupdater/watcher_mock_test.go github.com/juju/juju/core/watcher StringsWatcher
//
