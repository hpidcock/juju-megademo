...
//
//	mockgen -typed -package credentialvalidator -destination apiserver/facades/agent/credentialvalidator/watcher_mock.go github.com/juju/juju/core/watcher NotifyWatcher
//
