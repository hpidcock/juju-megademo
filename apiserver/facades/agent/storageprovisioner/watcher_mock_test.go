...
//
//	mockgen -typed -package storageprovisioner -destination apiserver/facades/agent/storageprovisioner/watcher_mock_test.go github.com/juju/juju/core/watcher StringsWatcher,MachineStorageIDsWatcher
//
...
// ChangeContext mocks base method.
func (m *MockMachineStorageIDsWatcher) ChangeContext(arg0 context.Context) context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChangeContext", arg0)
	ret0, _ := ret[0].(context.Context)
	return ret0
...
// ChangeContext indicates an expected call of ChangeContext.
func (mr *MockMachineStorageIDsWatcherMockRecorder) ChangeContext(arg0 any) *MockMachineStorageIDsWatcherChangeContextCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChangeContext", reflect.TypeOf((*MockMachineStorageIDsWatcher)(nil).ChangeContext), arg0)
	return &MockMachineStorageIDsWatcherChangeContextCall{Call: call}
}

// MockMachineStorageIDsWatcherChangeContextCall wrap *gomock.Call
type MockMachineStorageIDsWatcherChangeContextCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockMachineStorageIDsWatcherChangeContextCall) Return(arg0 context.Context) *MockMachineStorageIDsWatcherChangeContextCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockMachineStorageIDsWatcherChangeContextCall) Do(f func(context.Context) context.Context) *MockMachineStorageIDsWatcherChangeContextCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockMachineStorageIDsWatcherChangeContextCall) DoAndReturn(f func(context.Context) context.Context) *MockMachineStorageIDsWatcherChangeContextCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
